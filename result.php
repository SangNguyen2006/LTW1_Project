				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tr class="">
								<td><img src="../public/images/samsung-galaxy-tab-a-plus-97-sm-p555-n-190x190.jpg" /></td>
							...
							<tr class="">
								<td><img src="../public/images/ipad-pro-wifi-cellular-128gb-300-200x200.jpg" /></td>
								<td>iPad Pro wifi 32GB</td>
								<td>Tablet</td>
								<td>Apple</td>
								<td>iPad Pro được trang bị màn hình 12.9 inch, lớn nhất từ trước đến nay đối với các sản phẩm tablet phổ biến Apple trang bị cho iPad Pro vi xử lý A9X có hiệu năng cực kỳ mạnh mẽ và khả năng xử lý đồ họa vượt trội Camera iSign 8.0MP và camera Facetime 1.2MP đảm bảo chất lượng ảnh chụp cũng như video call</td>
								<td>19,999,000</td>
								<td>
									<a href="edit.php" class="btn btn-success btn-mini">Edit</a>
									<form action="" method="">
							...
							<tr class="">
								...
								<td>Màn hình:	AMOLED 16 triệu màu, 6.0", 1080 x 1920 pixels
									...
									Kết nối:	Wi-Fi 802.11 a/b/g/n/ac, Dual-band, DLNA, Wi-Fi Direct, Wi-Fi hotspot</td>
								<td>6,500,000</td>
								<td>
									<a href="edit.php" class="btn btn-success btn-mini">Edit</a>
									<form action="" method="">
							...
							<tr class="">
								<td><img src="../public/images/sony-xperia-z5-premium-detail-400x460.png" /></td>
